...
After extensive evaluation, the XGBoost Classifier emerged as the best-performing model, achieving a weighted F1 score of 0.97 on the evaluation data. 
